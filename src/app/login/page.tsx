    ...
    <div className="min-h-screen flex items-center justify-center p-5" style={{ background: "var(--bg)" }}>
      <div className="glass-card p-8 w-full max-w-sm text-center space-y-6">
        ...
        <div className="flex justify-center">
          ...
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-7 h-7" style={{ color: "var(--accent)" }}>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all hover:brightness-105"
        ...
        <p className="text-[10px]" style={{ color: "var(--fg-faint)" }}>
          Kun autoriserte kontoer har tilgang
        </p>
      </div>
    </div>
  );
